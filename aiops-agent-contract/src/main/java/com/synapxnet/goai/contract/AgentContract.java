 ...
 * English: Defines the shared Agent request, response and verified invocation context contracts.
 */
public final class AgentContract {
     ...
     * English: Checks the verified request context and requires the body, route and header to name the same tool.
     */
     ...
     * @param <T> 领域响应类型
     * @return 成功工具响应
     * English: Creates a read-only evidence response with source version, collection time and evidence identity.
     */
     ...
     * @param <T> 动作响应类型
     * @return 写工具成功响应
     * English: Creates the existing compatible result envelope including an audit receipt; this helper does not execute a mutation.
     */
     ...
     * @param <T> 参数 DTO 类型
     * English: Defines the immutable evidence contract for scoped platform integration.
     */
     ...
     * @param <T> 领域响应类型
     * English: Describes the structured tool response and public failure details used by callers.
     */
     ...
     * English: Carries tool identity, trace attribution and source evidence metadata.
     */
    ...
    /**
     * 表示由受控写操作产生的追加式审计回执。
     * English: Represents an append-only audit receipt from a governed write operation.
     */
     ...
     * English: Carries the trusted workspace, actor and routing context from delegation verification.
     */
    public record RequestContext(
         ...
         * English: Returns a new immutable request context bound to the validated request identifier.
         */
