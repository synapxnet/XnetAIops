 ...
 * English: Validates delegated identities and tool routing before binding trusted request context.
 */
final class AgentRequestContextFilter extends OncePerRequestFilter {
     ...
     * English: Validates delegated identity and tool scope for Agent v1 requests, then clears diagnostic context.
     */
    @Override
     ...
     * English: Writes a redacted JSON error without exposing tokens or internal exceptions.
     */
     ...
     * @return 已校验 Header 值
     * English: Requires a bounded ASCII context header and rejects missing or malformed values.
     */
     ...
     * English: Rejects disagreement between the tool route and the declared tool header.
     */
     ...
     * English: Adds non-secret trace identifiers to the per-request diagnostic context.
     */
